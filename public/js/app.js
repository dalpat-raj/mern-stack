...
function initAdmin(socket) {
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n            <p>".concat(menuItem.title, " - ").concat(menuItem.qty, " pcs </p>\n            ");
    }).join('');
  }
  ...
  function renderPrice(items) {
    var parsedItems = Object.values(items);
    return parsedItems.map(function (menuItem) {
      return "<p>\u20B9 ".concat(menuItem.price * menuItem.qty, "</p>");
    }).join('');
  }
...
updateStatus(order);
(0,_stripe__WEBPACK_IMPORTED_MODULE_3__.initStripe)(); // socket.io 
...
var humbger = document.getElementById('humbger');
var navbarr = document.querySelector('.navbarr');
var menuclose = document.querySelector('.menu-close');
humbger.addEventListener('click', function (e) {
  navbarr.style.top = "0";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51KOzOJKH6F09BQmiNG9uAknFllcMVkPpCvXDdFfnZcgxMwVoAJ3j0OMER2gANMCCCd5Xwhpk9Dqzc537u1ZAhFFa00Z72yu0V8');
          ...
          case 8:
            ...
            if (paymentForm) {
              paymentForm.addEventListener('submit', function (e) {
                ...
                if (!card) {
                  // ajax call 
                  (0,_apiService__WEBPACK_IMPORTED_MODULE_2__.placeOrder)();
                  return;
                } // verify card 
